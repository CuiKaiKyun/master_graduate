...
features = {'Gel_Strength', 'Centrifuge_Water_Loss', 'FreezeThaw_Water_Loss', 'Viscosity', ...
            'Yield_Stress', 'Adhesiveness', 'Applicability', 'Particle_Uniformity', 'Stirring_Uniformity', 'Texture_Preference'};
...
for i = 1:length(features)
    ...
    text(target_x, target_y, features{i}, 'FontSize', 10, 'FontWeight', 'bold', ...
         ...
         'BackgroundColor', [1 1 1 0.85], 'EdgeColor', [0.8 0.8 0.8], 'Margin', 2, 'FontName', 'Times New Roman');
end
...
title('PCA Biplot', 'FontSize', 14, 'FontName', 'Times New Roman');
