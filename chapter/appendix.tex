...
姿态角分量对姿态角的偏导矩阵$\boldsymbol{A_{\eta\eta}}$满足：
\begin{equation}
    \begin{aligned}
        \boldsymbol{A_{\eta\eta}} =& \frac{\partial (\boldsymbol{\eta} + \boldsymbol{Q}\boldsymbol{\omega}^b \triangle t)}{\partial \boldsymbol{\theta}} = \boldsymbol{I}_{3 \times 3} + \frac{\partial \boldsymbol{Q}\boldsymbol{\omega}^b}{\partial \boldsymbol{\theta}}\triangle t \\[6pt]
